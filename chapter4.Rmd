...
Let's first load the data again. 
...
Now we need to apply the equation and then bring it into a proper format for plotting:  
  
```{r question 4H6 part 3}
x_seq <- seq(from = min(cherry_blossoms$year), 
